...
interface PublicAttendanceTableProps {
...
export function PublicAttendanceTable({ participants, isLoading }: PublicAttendanceTableProps) {
  ...
  if (participants.length === 0 && !isLoading) {
    return (
      <div className="flex flex-col items-center justify-center h-64 border rounded-md shadow-sm bg-card">
        ...
        <h3 className="text-xl font-semibold text-muted-foreground">No Attendance Data Available</h3>
